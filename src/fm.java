...
public class fm extends ea {
    ...
    public fm(eq parameq, double paramDouble1, double paramDouble2, double paramDouble3) {
        this(parameq);
    ...
    public void l() {
        Boat boat = new Boat(this);
        etc.getLoader().callHook(PluginLoader.Hook.VEHICLE_DESTROYED, boat);
        super.l();
    }
    ...
    public void b_() {
        ...
        for (int j = 0; j < i; j++) {
            ...
            dw localdw = dw.b(this.z.a, d3, this.z.c, this.z.d, d5, this.z.f);
            if (this.l.b(localdw, jy.f)) {
                d1 += 1.0D / i;
            }
        }
        double d7;
        ...
        if ((localList != null) && (localList.size() > 0)) {
            for (int n = 0; n < localList.size(); n++) {
                ea localea = (ea) localList.get(n);
                if ((localea != this.j) && (localea.v()) && ((localea instanceof fm))) {
                    localea.c(this);
                }
            }
        }
