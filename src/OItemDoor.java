public class OItemDoor extends OItem {
    ...
    public boolean a(OItemStack paramOItemStack, OEntityPlayer paramOEntityPlayer, OWorld paramOWorld, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        ...
        int i = OMathHelper.b((paramOEntityPlayer.v + 180.0F) * 4.0F / 360.0F - 0.5D) & 0x3;
        ...
        int i1 = (paramOWorld.a(paramInt1 - j, paramInt2, paramInt3 - k) == localOBlock.bi) || (paramOWorld.a(paramInt1 - j, paramInt2 + 1, paramInt3 - k) == localOBlock.bi) ? 1 : 0;
        int i2 = (paramOWorld.a(paramInt1 + j, paramInt2, paramInt3 + k) == localOBlock.bi) || (paramOWorld.a(paramInt1 + j, paramInt2 + 1, paramInt3 + k) == localOBlock.bi) ? 1 : 0;
        ...
        paramOWorld.e(paramInt1, paramInt2 + 1, paramInt3, localOBlock.bi);
