  ...
  implements eu
{
  ...
  public void a(hz paramhz)
  {
    ...
    if (i4 > i5) i5 = i4;
    if (paramhz.e == 0) {
      if ((i5 > 16) || (bool)) this.e.c.a(n, i1, i2); 
    }
    else if (paramhz.e == 2) {
      this.e.c.a();
    } else if (paramhz.e == 1) {
      if ((i5 > 16) || (bool)) this.e.c.a(n, i1, i2, i3); 
    }
    else if (paramhz.e == 3) {
  ...
  public void a(u paramu) {
    if (paramu.a == -1) this.e.ak.a = paramu.b;
    if (paramu.a == -2) this.e.ak.c = paramu.b;
    if (paramu.a == -3) this.e.ak.b = paramu.b; 
  }
