...
public class de extends is {
    ...
    private boolean a(fv paramfv, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean) {
        if (paramBoolean) {
            b.add(new lf(paramInt1, paramInt2, paramInt3, paramfv.e));
        }
        int i = 0;
    ...
    private boolean g(fv paramfv, int paramInt1, int paramInt2, int paramInt3) {
        ...
        if ((i == 5) && (paramfv.k(paramInt1, paramInt2 - 1, paramInt3, 0))) {
            return true;
        }
        if ((i == 3) && (paramfv.k(paramInt1, paramInt2, paramInt3 - 1, 2))) {
            return true;
        }
        if ((i == 4) && (paramfv.k(paramInt1, paramInt2, paramInt3 + 1, 3))) {
            return true;
        }
        if ((i == 1) && (paramfv.k(paramInt1 - 1, paramInt2, paramInt3, 4))) {
            return true;
        }
    ...
    public void a(fv paramfv, int paramInt1, int paramInt2, int paramInt3, Random paramRandom) {
        ...
        if (a) {
            if (bool) {
                ...
                int current = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Object[]{new Block(this.bi, paramInt1, paramInt2, paramInt3), 1, 0});
                if (current == 0) {
            ...
            // hMod: Allow redstone torches to provide power
            int current = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Object[]{new Block(this.bi, paramInt1, paramInt2, paramInt3), 0, 1});
            if (current > 0) {
