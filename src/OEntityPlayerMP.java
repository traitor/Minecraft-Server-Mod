...
public class OEntityPlayerMP extends OEntityPlayer
        implements OICrafting {
    ...
    public void n() {
        ...
        for (int i = 0; i < f.size(); i++) {
            ...
            double d2 = ((OChunkCoordIntPair) localObject2).a(this);
            if ((i == 0) || (d2 < d1)) {
                localObject1 = localObject2;
                d1 = ((OChunkCoordIntPair) localObject2).a(this);
            }
        }
