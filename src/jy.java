...
public class jy extends dx
{
  ...
  public float ax;
  public float ay;
  public float az = 0.0F; public float aA = 0.0F;
  protected float aB;
  protected float aC;
  protected float aD;
  protected float aE;
  ...
  public boolean a(dx paramdx, int paramInt)
  {
     ...
     * dw = entity arrow
     * fk = boat
     * fx = base living human
     * er = player
     * gj = lava entity(fx ? )
     * ib = falling sand
     * jm = minecart
     * ke = fish ?
     * jy = base for living beings
     * gb = mob entity ( t = giant; bv = spider; fb = skeleton; fm = creeper; gi = zombie; iy = pigzombie )
     * ax = animals (ig = chicken; hs = pig; cu = sheep; bf = cow )
     * hy = flying object ( ghast ? )
     */
    ...
    if (aQ <= 0) {
      if (i != 0) l.a(this, f(), h(), (W.nextFloat() - W.nextFloat()) * 0.2F + 1.0F);
      f(paramdx);
    }
    else if (i != 0) { l.a(this, e(), h(), (W.nextFloat() - W.nextFloat()) * 0.2F + 1.0F);
    }
  ...
  {
    if ((aL > 0) && (paramdx != null)) paramdx.b(this, aL);
    aZ = true;
  ...
  public void E()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
      for (int i = 0; i < localList.size(); i++) {
        ...
        if (!localdx.v()) continue; localdx.c(this);
      }
  }
  ...
  protected void c()
  {
    ...
    boolean bool1 = r();
    boolean bool2 = t();
    if ((bool1) || (bool2)) br = (W.nextFloat() < 0.8F);
  }
  ...
  public bd c(float paramFloat) {
    ...
    if (paramFloat == 1.0F) {
      ...
      return bd.b(((double)f2 * f3), (double) f4, (double) f1 * f3);
    }
