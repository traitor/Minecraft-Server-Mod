...
public class fb extends hr {
    ...
    private void a(fv paramfv, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6) {
        ...
        if (bool) {
            ...
            for (k = 0; k < 4; k++) {
                ...
                if ((m != paramInt4) || (paramInt2 != paramInt5) || (n != paramInt6)) {
                    j = f(paramfv, m, paramInt2, n, j);
                }
                if ((paramfv.d(m, paramInt2, n)) && (!paramfv.d(paramInt1, paramInt2 + 1, paramInt3))) {
                    if ((m == paramInt4) && (paramInt2 + 1 == paramInt5) && (n == paramInt6)) {
                        continue;
                    }
                    j = f(paramfv, m, paramInt2 + 1, n, j);
                } else if ((!paramfv.d(m, paramInt2, n)) && ((m != paramInt4) || (paramInt2 - 1 != paramInt5) || (n != paramInt6))) {
                    j = f(paramfv, m, paramInt2 - 1, n, j);
                }
            }
            if (j > 0) {
        ...
        if (i != j) {
            j = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Object[]{new Block(this.bi, paramInt1, paramInt2, paramInt3), i, j});
        }
    ...
    public boolean b(la paramla, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        ...
        if (paramla.b(paramInt1, paramInt2, paramInt3) == 0) {
            return false;
        }
        ...
        if (!paramla.d(paramInt1, paramInt2 + 1, paramInt3)) {
            if ((paramla.d(paramInt1 - 1, paramInt2, paramInt3)) && (b(paramla, paramInt1 - 1, paramInt2 + 1, paramInt3))) {
                i = 1;
            }
            if ((paramla.d(paramInt1 + 1, paramInt2, paramInt3)) && (b(paramla, paramInt1 + 1, paramInt2 + 1, paramInt3))) {
                j = 1;
            }
            if ((paramla.d(paramInt1, paramInt2, paramInt3 - 1)) && (b(paramla, paramInt1, paramInt2 + 1, paramInt3 - 1))) {
                k = 1;
            }
            if ((paramla.d(paramInt1, paramInt2, paramInt3 + 1)) && (b(paramla, paramInt1, paramInt2 + 1, paramInt3 + 1))) {
                m = 1;
