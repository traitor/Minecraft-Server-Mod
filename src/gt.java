...
public class gt
{
  ...
  public void a(dx paramdx)
  {
    ...
    else if ((paramdx instanceof ke)) { a(paramdx, 64, 5, true);
    } else if ((paramdx instanceof gj)) { a(paramdx, 64, 20, true);
    } else if ((paramdx instanceof jm)) { a(paramdx, 160, 5, true);
    } else if ((paramdx instanceof fk)) { a(paramdx, 160, 5, true);
    } else if ((paramdx instanceof af)) { a(paramdx, 160, 3);
    } else if ((paramdx instanceof cj)) { a(paramdx, 160, 10, true); }
  }
  ...
  public void a(dx paramdx, int paramInt1, int paramInt2, boolean paramBoolean) {
    ...
    if (this.b.b(paramdx.g)) throw new IllegalStateException("Entity is already tracked!");
  ...
  public void a() {
    ArrayList<er> localArrayList = new ArrayList<er>();
    Object localObject;
    
    for (Iterator<gu> localIterator1 = this.a.iterator(); localIterator1.hasNext(); ) { localObject = (gu)localIterator1.next();
      ((gu)localObject).a(this.c.e.d);
      if ((((gu)localObject).o) && ((((gu)localObject).a instanceof er)))
        localArrayList.add((er)((gu)localObject).a);
    }
    
    for (int i = 0; i < localArrayList.size(); i++) {
      localObject = (er)localArrayList.get(i);
      for (gu localgu : this.a)
