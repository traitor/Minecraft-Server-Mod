public class OItemSign extends OItem {
    ...
    public boolean a(OItemStack paramOItemStack, OEntityPlayer paramOEntityPlayer, OWorld paramOWorld, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        ...
        Block blockPlaced = new Block((paramInt4 == 1 ? OBlock.aD.bi : OBlock.aI.bi), paramInt1, paramInt2, paramInt3);
        ...
        if (paramInt4 == 1)
            paramOWorld.b(paramInt1, paramInt2, paramInt3, OBlock.aD.bi, OMathHelper.b((paramOEntityPlayer.v + 180.0F) * 16.0F / 360.0F + 0.5D) & 0xF);
        else
            paramOWorld.b(paramInt1, paramInt2, paramInt3, OBlock.aI.bi, paramInt4);
