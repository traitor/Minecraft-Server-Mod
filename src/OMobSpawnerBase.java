...
public class OMobSpawnerBase {
    ...
    protected Class<?>[] r;
    //protected Class[] r = {OEntitySpider.class, OEntityZombie.class, OEntitySkeleton.class, OEntityCreeper.class, OEntitySlime.class};
    protected Class<?>[] s;
    //protected Class[] s = {OEntitySheep.class, OEntityPig.class, OEntityChicken.class, OEntityCow.class};
    protected Class<?>[] t;
